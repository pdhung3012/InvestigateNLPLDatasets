...
fpTrainLabel=fopMixDataAndLabel+'train.label.numStmt.txt'
fpTestPLabel=fopMixDataAndLabel+'testP.label.numStmt.txt'
fpTestWLabel=fopMixDataAndLabel+'testW.label.numStmt.txt'

fopD2VRF=fopResultMLs+'numStmt-pseudoAndContext-tfidf-lda/'
