...
def checkAndGenerateAST(i, lstCFilesStep1, fopStep2,fopASTInfo,fpLog,parser):
...
def compileMixCCodeAndSave(fopStep1,fopStep2,fopASTInfo,fpLog,parser):
    ...
    t = time.time()
    Parallel(n_jobs=8)(delayed(checkAndGenerateAST)(i,lstCFilesStep1, fopStep2, fopASTInfo,fpLog,parser) for i in range(0,len(lstCFilesStep1)))
    print(time.time() - t)
...
numOmit=30
compileMixCCodeAndSave(fopStep1TestPMixFiles,fopStep2TestPMixFiles,fopStep3TestPMixFiles,fpLogTestP,parser)
compileMixCCodeAndSave(fopStep1TestWMixFiles,fopStep2TestWMixFiles,fopStep3TestWMixFiles,fpLogTestW,parser)
compileMixCCodeAndSave(fopStep1TrainMixFiles,fopStep2TrainMixFiles,fopStep3TrainMixFiles,fpLogTrain,parser)
