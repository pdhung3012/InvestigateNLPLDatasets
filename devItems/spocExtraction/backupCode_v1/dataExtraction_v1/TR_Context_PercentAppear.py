...
fpTrainLabel=fopMixDataAndLabel+'train.label.percentAppear.txt'
fpTestPLabel=fopMixDataAndLabel+'testP.label.percentAppear.txt'
fpTestWLabel=fopMixDataAndLabel+'testW.label.percentAppear.txt'

fopD2VRF=fopResultMLs+'percentAppear-pseudoAndContext-tfidf-lda/'
...
lstSortedLabels=sorted(map(int,sorted(set(y_all))))
dictSortedLbls={}
for i in range(0,len(lstSortedLabels)):
    dictSortedLbls[str(lstSortedLabels[i])]=lstSortedLabels[i]
