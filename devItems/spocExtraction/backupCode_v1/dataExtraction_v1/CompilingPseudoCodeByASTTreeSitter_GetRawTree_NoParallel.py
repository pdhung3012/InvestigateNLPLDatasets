...
from LibForGraphExtractionFromPseudoCode import getJsonDict
...
fopCorrectFiles= fopData + 'step1_pseudo/'
fopASTFiles=fopData+'step3_pseudo_treesitter/'
fopCompiledFiles=fopData+'step2_pseudo/'
fopStep4GraphAll=fopData+'step4_pseudo_graphAll/'
fopStep4GraphSimplify=fopData+'step4_pseudo_graphSimplify/'
fopStep1TrainMixFiles= fopCorrectFiles + 'train/'
fopStep1TestPMixFiles= fopCorrectFiles + 'testP/'
fopStep1TestWMixFiles= fopCorrectFiles + 'testW/'
