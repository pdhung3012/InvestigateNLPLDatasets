...
fopStatisticFolder=fopData+'textInSPOC/testWSPOCPlain/'
fpCombineAllText= fopTextInSPoC + 'combinePseudoCode_TestW.txt'
fpCombineAllCode= fopTextInSPoC + 'combineProgram_TestW.txt'
