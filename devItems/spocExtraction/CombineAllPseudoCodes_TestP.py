...
fopStatisticFolder=fopData+'textInSPOC/testPSPOCPlain/'
fpCombineAllText= fopTextInSPoC + 'combinePseudoCode_TestP.txt'
fpCombineAllCode= fopTextInSPoC + 'combineProgram_TestP.txt'
