...
fopMixVersion=fopRoot+'step4_Inconsistent_v2/'
fpDictLiterals=fopRoot+'step2_dictLiterals_all.txt'
strSplitCharacterForNodeEdge = '_ABAZ_'
fopStep5GraphInc=fopRoot+'step5_inconsistent/'
lstContexts=['0']

for strContext in lstContexts:
    fopTotalGraphAll= fopRoot + 'step5_origin/'+strContext+'/'
    fpFileCachedVersion=fopRoot + 'step5_origin/'+'cached_graph_'+strContext+'.txt'
