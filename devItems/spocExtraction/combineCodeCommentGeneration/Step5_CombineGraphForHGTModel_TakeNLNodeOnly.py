...
fopMixVersion=fopRoot+'step4_takeLeafNLNodes/'
fpDictLiterals=fopRoot+'step2_dictLiterals_all.txt'
strSplitCharacterForNodeEdge = ' ABAZ '
lstContexts=['1','3','5','all']

for strContext in lstContexts:
    fopTotalGraphAll= fopRoot + 'step5_takeLeafNLNodes/'+strContext+'/'
    fpFileCachedVersion=fopRoot + 'step5_takeLeafNLNodes/'+'cached_graph_'+strContext+'.txt'
