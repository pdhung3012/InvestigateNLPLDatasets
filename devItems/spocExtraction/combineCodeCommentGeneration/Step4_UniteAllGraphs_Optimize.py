...
fopStep4NMT=fopRoot+'step4_NMT_optimization/'
...
fopOutGraph=fopStep3V2+'graphEntityInfo/'
createDirIfNotExist(fopOutGraph)
...
for i in range(0,len(arrLocs)):
    ...
    for key in dictContextAndPOS.keys():
        fpGraphKey=fopStep4NMT+arrTabLocs[1]+'__'+arrTabLocs[0]+'__'+str(lineInRealCode+1)+'/graphFilter_'+key+'.dot'
        strGraph=''
        try:
            ...
            dictContextAndPOS[key].append('ERROR')
